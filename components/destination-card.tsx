    ...
    return (
      ...
      >
        ...
        >
          ...
          {/* Content */}
          <div className="relative flex flex-col justify-end h-full p-6 text-white min-h-[300px]">
            ...
            <div className="mt-8 flex items-center justify-between bg-[hsl(var(--theme-color)/0.2)] backdrop-blur-md border border-[hsl(var(--theme-color)/0.3)] 
              ...
              <span className="text-sm font-semibold tracking-wide">Zobacz szczegóły</span>
