        ...
        <SidebarMenuItem>
          <SidebarMenuButton size="lg" className="cursor-default">
            ...
            <div className="grid min-w-0 flex-1 text-left text-sm leading-tight">
              <span className="font-medium">Brak wycieczek</span>
      ...
      <SidebarMenuItem>
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <SidebarMenuButton
              size="lg"
              className="!h-auto min-h-12 items-start data-[state=open]:bg-sidebar-accent data-[state=open]:text-sidebar-accent-foreground"
            >
              <div className="flex aspect-square size-8 shrink-0 items-center justify-center rounded-lg bg-sidebar-primary text-sidebar-primary-foreground">
                <MapPin className="size-4" />
              </div>
              ...
              <ChevronsUpDown className="mt-1 ml-auto shrink-0" />
            </SidebarMenuButton>
          </DropdownMenuTrigger>
          <DropdownMenuContent
